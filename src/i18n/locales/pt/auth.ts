export default {
  ...
  adminEnter: "Entrar",
  adminEntryLabel: "Centro de Operações",
  adminEntryAria: "Centro de Operações",
  saasEntryLabel: "Centro de Operações YourMeal OS",
  saasEntryAria: "Centro de Operações YourMeal OS",
  saasEntrySubtitle: "Administração da plataforma SaaS",
  adminNotStaff: "Esta conta não tem acesso ao Centro de Operações.",
  adminNotStaffHint:
  ...
  signInInvalidCredentials: "O email ou a palavra-passe não estão corretos.",
  signInEmailNotConfirmed:
    "O seu email ainda não está confirmado. Verifique a caixa de entrada.",
  signInRateLimit:
    "Demasiadas tentativas. Espere alguns minutos e tente novamente.",
  signInNetwork:
    "Não conseguimos ligar ao serviço. Verifique a ligação e tente novamente.",
  signInUnexpected:
