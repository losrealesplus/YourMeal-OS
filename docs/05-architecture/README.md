...
| [CUSTOMER_CAPABILITY.md](./CUSTOMER_CAPABILITY.md) | Customer Capability · OPERATIONAL-002 · Engineering Certified |
| [ORDER_CAPABILITY.md](./ORDER_CAPABILITY.md) | Order Capability · OPERATIONAL-003 · weekly operational commitment |
