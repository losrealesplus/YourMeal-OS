...
☑ RELEASE-ROLLBACK-003 (este PR)             → ▶ FULL PASS · [ACTA](../10-validation/release-rollback/RELEASE_ROLLBACK_003_R3_ACTA.md)
```

**DoR CERTIFIED** · Spec ✅ · Runner ✅ · Gate ✅ · **001 CERTIFIED** · **002 CERTIFIED** · **003 ▶ este PR** (R3 only).  
...
| 5 | Capacidades / PRs Rollback (001…003) | ✅ 001 · ✅ 002 · ▶ 003 este PR |
