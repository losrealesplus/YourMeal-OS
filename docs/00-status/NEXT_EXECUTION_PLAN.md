...
| Beta Acceptance | ▶ | DoR ✅ · Spec ✅ · Runner ✅ · Gate ✅ · 001 ▶ B1 · [ACTA](../10-validation/release-01-beta/RELEASE_01_BETA_001_B1_ACTA.md) → `release-01-beta` |
...
**Objetivo actual Track B:** **RELEASE-01-BETA-001** (B1 Foundation · este PR).  
DoR ✅ · Spec ✅ · Runner ✅ (#219) · Gate ✅ (#220).  
Contrato: `npm run test:release-01-beta` → PASS through B1 · BLOCKED at `RELEASE_01_BETA_B2_STARTED` · exit 0.  
Do **not** open B2–B5 · FLOW-05 · tag in 001.  
...
```text
Track B (prioridad): RELEASE-01-BETA-001 (B1) → Land Check → 002…005 → release-01-beta
