...
| Beta Acceptance | ▶ | DoR ✅ · Spec ✅ · Runner ✅ #219 · Gate ✅ READY · next 001 · [GATE](../10-validation/release-01-beta/RELEASE_01_BETA_GATE.md) → `release-01-beta` |
...
**Objetivo actual Track B:** **RELEASE-01-BETA-001** (B1 Foundation only).  
DoR ✅ (#217) · Spec ✅ FROZEN (#218) · Runner ✅ (#219 · `3994833`).  
Land Check desde `main`: BLOCKED at `RELEASE_01_BETA_B1_STARTED` · exit 2 · `evidence={}`.  
Gate ✅ **READY** → open **BETA-001 only** (no B2–B5 · no FLOW-05).  
...
```text
Track B (prioridad): RELEASE-01-BETA-001 (B1 only) → 002…005 → release-01-beta
