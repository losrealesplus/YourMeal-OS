...
Sprint activo
  ...
  Prioridad                    Track B › RELEASE-ROLLBACK-003 (R3 · este PR)
                               002 ✅ CERTIFIED #214 · 2838138 · cert #215
                               npm run test:release-rollback → FULL PASS · R3 · blocked_at=—
                               → ../10-validation/release-rollback/RELEASE_ROLLBACK_003_R3_ACTA.md
