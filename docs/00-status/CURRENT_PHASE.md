...
Sprint activo
  ...
  Prioridad                    Track B › RELEASE-01-BETA-003 (B3 · este PR)
                               B1–B2 ✅ CERTIFIED #222 · #223 · 3b837c5
                               npm run test:release-01-beta → PASS through B3 · BLOCKED at B4
                               → ../10-validation/release-01-beta/RELEASE_01_BETA_003_B3_ACTA.md
