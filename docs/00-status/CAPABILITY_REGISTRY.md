...
**Expansion era:** [OPERATIONAL_EXPANSION](./OPERATIONAL_EXPANSION.md) · first module OPERATIONAL-006 Delivery (**Facade**) · [Language Dictionary](./OPERATIONAL_LANGUAGE_DICTIONARY.md)
...
| Delivery | Operational Execution | **Facade** | Billing |
...
**Expansion:** OPERATIONAL-006 Delivery · **Facade** (ADR 0078 · 0079).
...
| Version | 0.2 (Facade) |
| ADRs | [0078](../adr/0078-delivery-capability.md) · [0079](../adr/0079-delivery-facade.md) |
...
| Notes | ConfirmDelivery composed · Assign/Start/Exception/Close/Routes UNIMPLEMENTED |
...
Second **Operational Execution** Capability — Facade live.  
**Next:** Engineering Certification (no FLOW-002 yet).
...
**Expansion:** [OPERATIONAL_EXPANSION](./OPERATIONAL_EXPANSION.md) — Delivery Facade → Certification → …  
