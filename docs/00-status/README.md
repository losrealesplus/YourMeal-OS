...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** (FLOW-01…04 ✅) · Track B **[Smoke Spec](./RELEASE_SMOKE_SPEC.md)** READY FOR FREEZE · [**RELEASE-01**](./RELEASE_01_BETA_STRATEGY.md) · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [**FOPEBA_METRICS**](./FOPEBA_METRICS.md) v0 · [**PROJECT_HANDOFF**](./PROJECT_HANDOFF.md) · [FLOW_CATALOG](./FLOW_CATALOG.md) · [FLOW_GOVERNANCE](./FLOW_GOVERNANCE.md)  
