...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** (FLOW-01…04 ✅ · Track B Smoke…Rollback ✅) · Track B **[RELEASE-01-BETA-001 B1](../10-validation/release-01-beta/RELEASE_01_BETA_001_B1_ACTA.md)** · PASS through B1 · [**Spec](./RELEASE_01_BETA_SPEC.md)** FROZEN · [**FOPEBA Land Check](./FOPEBA_LAND_CHECK.md)** · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [FLOW_CATALOG](./FLOW_CATALOG.md)  
