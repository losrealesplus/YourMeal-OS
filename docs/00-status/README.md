...
**RI-001:** **[PROGRAM FROZEN](./RI001_PROGRAM_FROZEN.md)** · [Backlog A–I](./RI001_OPERATIONAL_READINESS_BACKLOG.md) · Evidence Gates · [P13](../20-evidence-framework/12-certification-completeness-p13.md) · **[EP-OPS-003 Journeys](./EP_OPS_003_WORKSPACE_OPERATIONAL_JOURNEY.md)**  
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← abrir primero · **certificación operacional** (alcance cerrado)  
...
**Gobernanza:** [Acta — Fin construcción metodológica](./ACTA_METHODOLOGY_CONSTRUCTION_CLOSED.md) **Cerrada** · [ACT-001 Experience Baseline Frozen](./ACT-001_EATCLEAN_EXPERIENCE_BASELINE_FROZEN.md) ✅ · [ACT-002 Materialization Frozen](./ACT-002_FOUNDATION_OF_MATERIALIZATION_FROZEN.md) ✅ · [**Identity Freeze v1**](./IDENTITY_FREEZE_v1.md) ✅  
