...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** (FLOW-01…04 ✅ · Track B Smoke…Rollback ✅) · **[RELEASE-01-BETA CERTIFIED](../10-validation/release-01-beta/RELEASE_01_BETA_PASS_ACTA.md)** · tag `release-01-beta` → `facb917` · Next: RELEASE-01 DoR · [**FOPEBA Land Check](./FOPEBA_LAND_CHECK.md)** · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [FLOW_CATALOG](./FLOW_CATALOG.md)  
