...
**Product Core track:** [PRODUCT_CORE_001](./PRODUCT_CORE_001.md) — Architecture…Ready Gate landed on `main`  
...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **EatClean Core next** · Foundation ✅ · CAPACITOR ✅ · FLOW-05 ✅ · RELEASE-01 ✅ · [FLOW_CATALOG](./FLOW_CATALOG.md)  
