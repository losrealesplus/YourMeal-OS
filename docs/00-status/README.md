...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Flow Certification ▶ CURRENT** · [**PROJECT_HANDOFF**](./PROJECT_HANDOFF.md) · [**FOPEBA_METRICS**](./FOPEBA_METRICS.md) · [**RELEASE-01 Beta**](./RELEASE_01_BETA_STRATEGY.md) (DRAFT) · [**DoRl**](./DEFINITION_OF_RELEASE.md) (DRAFT) · [FLOW_CATALOG](./FLOW_CATALOG.md) · [FLOW_GOVERNANCE](./FLOW_GOVERNANCE.md)  
