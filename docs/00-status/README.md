...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** · `release-01-beta` ✅ · **[RELEASE-01 DoR](./RELEASE_01_DOR.md)** · [**Strategy](./RELEASE_01_STRATEGY.md)** · [PASS Beta](../10-validation/release-01-beta/RELEASE_01_BETA_PASS_ACTA.md) · [**FOPEBA Land Check](./FOPEBA_LAND_CHECK.md)** · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [FLOW_CATALOG](./FLOW_CATALOG.md)  
