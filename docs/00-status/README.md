...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** (FLOW-01…04 ✅ · Track B Smoke…Rollback ✅) · Track B **[RELEASE-01-BETA Gate READY](../10-validation/release-01-beta/RELEASE_01_BETA_GATE.md)** · READY TO OPEN **001 (B1)** · [**Spec](./RELEASE_01_BETA_SPEC.md)** FROZEN · [**FOPEBA Land Check](./FOPEBA_LAND_CHECK.md)** · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [FLOW_CATALOG](./FLOW_CATALOG.md)  
