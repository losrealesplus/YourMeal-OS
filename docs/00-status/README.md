...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Flow Certification ▶ CURRENT** · [FLOW_CERTIFICATION_OPEN](./FLOW_CERTIFICATION_OPEN.md) · [PR_TAXONOMY](./PR_TAXONOMY.md)  
