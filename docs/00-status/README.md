...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** · `release-01-beta` ✅ · **[RELEASE-01-003 P3](../10-validation/release-01/RELEASE_01_003_P3_ACTA.md)** · PASS through P3 · [**Spec](./RELEASE_01_SPEC.md)** FROZEN · [**FOPEBA Land Check](./FOPEBA_LAND_CHECK.md)** · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [FLOW_CATALOG](./FLOW_CATALOG.md)  
