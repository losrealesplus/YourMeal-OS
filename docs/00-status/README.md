...
**Pre-piloto:** [PRE_PILOT_AUDIT](./PRE_PILOT_AUDIT.md) · [ORR Party/B2B/B2C](./ORR_B2B_B2C_PARTY.md) · [**PILOT_ACCEPTANCE_CHECKLIST**](./PILOT_ACCEPTANCE_CHECKLIST.md) (G-02) · [Functional Completeness Review](./EATCLEAN_PILOT_FUNCTIONAL_COMPLETENESS_REVIEW.md) · [**EP-001 Sprint**](./EP001_FUNCTIONAL_COMPLETENESS_SPRINT.md)  
