...
```text
Operación real → Discovery → Patrón → Blueprint → Capability
→ Use Cases → Implementación → Integración → Operación real
```
...
### Primera jornada observada

No para enseñar la app. Para **aprender**.

Checklist: [FIRST_OBSERVATION_DAY.md](../16-operational-discovery/FIRST_OBSERVATION_DAY.md)

En paralelo (Capability ya validada): Integration + UI MVP de Dish Management.
