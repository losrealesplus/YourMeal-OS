...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** (FLOW-01…04 ✅ · Smoke ✅) · Track B **[Cross-flow C4 FULL PASS](../10-validation/release-crossflow/RELEASE_CROSSFLOW_PASS_ACTA.md)** (tag tras Land Check `main`) · [**FOPEBA Land Check](./FOPEBA_LAND_CHECK.md)** · [**RELEASE-01**](./RELEASE_01_BETA_STRATEGY.md) · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [FLOW_CATALOG](./FLOW_CATALOG.md)  
