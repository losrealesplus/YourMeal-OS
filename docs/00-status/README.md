...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** (FLOW-01…04 ✅ · Track B Smoke…Rollback ✅) · Track B **[RELEASE-01-BETA-005 B5](../10-validation/release-01-beta/RELEASE_01_BETA_005_B5_ACTA.md)** · FULL PASS through B5 · [**Spec](./RELEASE_01_BETA_SPEC.md)** FROZEN · [**FOPEBA Land Check](./FOPEBA_LAND_CHECK.md)** · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [FLOW_CATALOG](./FLOW_CATALOG.md)  
