...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Product as system ▶** (FLOW-01…04 ✅) · Track B **[Smoke Runner](../10-validation/release-smoke/RELEASE_SMOKE_RUNNER.md)** BLOCKED · [**Smoke Spec](./RELEASE_SMOKE_SPEC.md)** · [**RELEASE-01**](./RELEASE_01_BETA_STRATEGY.md) · [**DoRl**](./DEFINITION_OF_RELEASE.md) · [**FOPEBA_METRICS**](./FOPEBA_METRICS.md) v0 · [FLOW_CATALOG](./FLOW_CATALOG.md)  
