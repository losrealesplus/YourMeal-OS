...
**Fase actual:** [CURRENT_PHASE](./CURRENT_PHASE.md) ← **Flow Certification ▶ CURRENT** · [**PROJECT_HANDOFF**](./PROJECT_HANDOFF.md) (congelado 2026-08-02) · [**RELEASE-01 Beta**](./RELEASE_01_BETA_STRATEGY.md) (DRAFT) · [FLOW_CERTIFICATION_OPEN](./FLOW_CERTIFICATION_OPEN.md) · [FLOW_GOVERNANCE](./FLOW_GOVERNANCE.md) · [FLOW_FIRST](./FLOW_FIRST.md) · [FLOW_CATALOG](./FLOW_CATALOG.md) · [PR_TAXONOMY](./PR_TAXONOMY.md)  
