...
| Deployment · Rollback | ▶ 002 ✅ CERTIFIED · READY TO OPEN 003 · [ACTA](../10-validation/release-deploy/RELEASE_DEPLOY_002_D2_ACTA.md) | `release-deploy-pass` · `release-rollback-pass` |
