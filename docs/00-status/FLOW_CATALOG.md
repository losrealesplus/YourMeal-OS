...
**Fecha:** 2026-08-02  
**Estado:** FLOW-01…05 ✅ CERTIFIED · FLOW-05 tag `flow05-pass` · DoR estándar ✅ (#147)  
**Piloto:** EatClean  
...
|----|-------------------|-----------|--------|--------|
| **FLOW-05** | Customer Experience Lifecycle | Alta | Registro → … → Archived (B1–B8) | ✅ **CERTIFIED** · [PASS](../10-validation/flow-05/FLOW_05_PASS_ACTA.md) · tag `flow05-pass` · Spec ✅ [FROZEN](./FLOW_05_SPEC.md) |
