...
**Fecha:** 2026-08-02  
**Estado:** FLOW-01…04 ✅ CERTIFIED · FLOW-05 ▶ FLOW05-008 (B8) · DoR estándar ✅ (#147)  
**Piloto:** EatClean  
...
|----|-------------------|-----------|--------|--------|
| **FLOW-05** | Customer Experience Lifecycle | Alta | Registro → … → Archived (B1–B8) | ▶ **FLOW05-008 B8** · [Acta](../10-validation/flow-05/FLOW05_008_B8_ACTA.md) · CERTIFIED_THROUGH=8 · FULL PASS · Spec ✅ [FROZEN](./FLOW_05_SPEC.md) |
