...
| E2E | ▶ | 001 ▶ [E1](../10-validation/release-e2e/RELEASE_E2E_001_E1_ACTA.md) · Gate ✅ → tag `release-e2e-pass` |
...
B-03 E2E          DoR ✅ · Spec ✅ · Runner ✅ · Gate ✅ · 001 ▶ E1 → … → release-e2e-pass
...
├── E2E Tests               ▶  001 E1 → … → release-e2e-pass
