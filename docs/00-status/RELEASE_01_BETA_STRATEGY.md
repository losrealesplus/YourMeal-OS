...
| Rollback | ▶ | DoR ✅ · Spec ✅ · Runner ✅ · Gate ✅ · 001 ▶ R1 · [ACTA](../10-validation/release-rollback/RELEASE_ROLLBACK_001_R1_ACTA.md) → tag `release-rollback-pass` |
...
B-05 Rollback     DoR ✅ · Spec ✅ · Runner ✅ · Gate ✅ · 001 ▶ → release-rollback-pass
...
├── Rollback                ▶  001 R1 OPEN · BLOCKED at R2 → release-rollback-pass
