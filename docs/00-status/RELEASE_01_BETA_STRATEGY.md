...
| Deployment | ▶ | DoR ✅ · Spec ✅ · Runner ✅ #200 · Gate ✅ READY · next 001 · [GATE](../10-validation/release-deploy/RELEASE_DEPLOY_GATE.md) → tag `release-deploy-pass` |
...
B-04 Deployment   DoR ✅ · Spec ✅ · Runner ✅ · Gate READY → 001… → release-deploy-pass
...
├── Deployment              ▶  Gate READY · OPEN 001 (D1) → release-deploy-pass
├── Rollback                ⏳
