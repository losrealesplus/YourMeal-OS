...
| Cross-flow | ⏳ | 001 ▶ [C1 acta](../10-validation/release-crossflow/RELEASE_CROSSFLOW_001_C1_ACTA.md) → C2… → `release-crossflow-pass` |
...
B-02 Cross-flow   DoR ✅ · Spec ✅ · Runner ✅ · 001 ▶ C1 → … → release-crossflow-pass
...
├── Cross-flow Tests        ⏳  001 ▶ C1 · then C2…C4
