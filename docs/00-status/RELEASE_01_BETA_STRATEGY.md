...
| E2E | ▶ | Spec ✅ FROZEN #186 · Runner ⏳ READY TO OPEN · [SPEC](./RELEASE_E2E_SPEC.md) → tag `release-e2e-pass` |
...
B-03 E2E          DoR ✅ · Spec ✅ FROZEN → Runner ⏳ (BLOCKED at E1) → impl → release-e2e-pass
...
├── E2E Tests               ▶  Spec FROZEN · Runner READY TO OPEN → release-e2e-pass
