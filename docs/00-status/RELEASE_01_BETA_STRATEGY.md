...
| E2E | ▶ | Spec [RELEASE_E2E_SPEC](./RELEASE_E2E_SPEC.md) READY FOR FREEZE · DoR ✅ → tag `release-e2e-pass` |
...
B-03 E2E          DoR ✅ · Spec ▶ READY FOR FREEZE → Runner (BLOCKED) → impl → release-e2e-pass
...
├── E2E Tests               ▶  Spec READY FOR FREEZE → … → release-e2e-pass
