...
| Deployment | ▶ | DoR ✅ · Spec ✅ FROZEN · Runner ▶ [RUNNER](../10-validation/release-deploy/RELEASE_DEPLOY_RUNNER.md) · Gate NOT READY → tag `release-deploy-pass` |
...
B-04 Deployment   DoR ✅ · Spec ✅ FROZEN · Runner ▶ · Gate NOT READY → release-deploy-pass
...
├── Deployment              ▶  Runner BLOCKED at D1 · Gate NOT READY → release-deploy-pass
├── Rollback                ⏳
