...
| Deployment | ▶ | DoR ✅ · Spec ✅ FROZEN · next Runner · [SPEC](./RELEASE_DEPLOY_SPEC.md) → tag `release-deploy-pass` |
...
B-04 Deployment   DoR ✅ · Spec ✅ FROZEN · Runner ⏳ → release-deploy-pass
...
├── Deployment              ▶  Spec FROZEN · READY TO OPEN Runner → release-deploy-pass
├── Rollback                ⏳
