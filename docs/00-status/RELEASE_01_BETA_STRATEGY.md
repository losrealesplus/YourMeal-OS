...
| Rollback | ▶ | DoR ✅ · Spec ✅ · Runner ✅ #210 · Gate ✅ READY · next 001 · [GATE](../10-validation/release-rollback/RELEASE_ROLLBACK_GATE.md) → tag `release-rollback-pass` |
...
B-05 Rollback     DoR ✅ · Spec ✅ · Runner ✅ · Gate READY → 001… → release-rollback-pass
...
├── Rollback                ▶  Gate READY · OPEN 001 (R1) → release-rollback-pass
