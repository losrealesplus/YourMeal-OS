...
**Post-closeout:** [BUGFIX-002](./BUGFIX002_NAVIGATION_DECOUPLING.md) desacopla ensure PO de la navegación global (strict solo en Ops entry). Incluido en Auth Layer Frozen.
