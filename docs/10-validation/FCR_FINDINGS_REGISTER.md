...
| **FCR-002** | **Render Stability Regression** (síntoma: titileo/parpadeo en Ops) | **P1** | Render stability | ✅ **FIXED (código)** · ⏳ visual | Causa = loop `can` inestable. Fix: Platform Stabilization · [UI_STABILITY](./platform-stabilization/UI_STABILITY.md) |
