...
-- 2. Backfill existing historical data safely (Zero Invention Policy for Class C)
...
-- 3. Add CHECK constraint on price_snapshot_status
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 4. Add CHECK constraint on unit_price consistency
DO $$
BEGIN
  IF NOT EXISTS (
