...
export const EATCLEAN_COMMERCIAL_OFFERS: CommercialOffer[] = [
  ...
  },
  {
    ...
    code: "weekly_plan",
    title: "Plan Semanal",
    subtitle: "10% de ahorro por comida en tus pedidos semanales",
    description: "Planifica tus comidas de la semana con descuento directo por plato.",
    pricingModel: "per_unit",
    basePrice: {
      cents: 1190,
      currency: "EUR",
    ...
    slotsIncluded: 1,
    benefits: [
      "10% de descuento directo en cada comida (10,71 €/comida)",
      "10% de descuento en todos los extras",
      "Sin cantidad mínima ni máxima forzada",
    ...
    promotions: [
      {
        ...
        eligibility: "public",
        badgeLabel: "🟢 Ahorras 1,19 €/comida (10%)",
      },
      {
